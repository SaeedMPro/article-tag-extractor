...
func (c *articleServiceClient) ProcessArticles(ctx context.Context, in *ProcessArticlesRequest, opts ...grpc.CallOption) (*ProcessArticlesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProcessArticlesResponse)
	err := c.cc.Invoke(ctx, ArticleService_ProcessArticles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedArticleServiceServer) ProcessArticles(context.Context, *ProcessArticlesRequest) (*ProcessArticlesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProcessArticles not implemented")
}
...
func _ArticleService_ProcessArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProcessArticlesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArticleServiceServer).ProcessArticles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArticleService_ProcessArticles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).ProcessArticles(ctx, req.(*ProcessArticlesRequest))
	}
...
var ArticleService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/proto/article_service.proto",
}
